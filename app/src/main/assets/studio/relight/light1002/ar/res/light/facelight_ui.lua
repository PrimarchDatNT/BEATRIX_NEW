...
ui = { 
    shadow = { 
        ui_name = "人脸", ui_type = "groupbox", visible = true,
        shadowColor = { b = 62.00, ui_format = "r&g&b", ui_type = "color", ui_name = "阴影颜色", r = 116.00, g = 77.00 },
        lightMax = { ui_name = "最大:", precision = 2.00, value = 0.03, ui_type = "slider", min = 0.00, max = 2.00, step = 0.02 },
        ...
        lightInfo = { 
            ...
            light_1 = { 
                ...
                direction_z = { ui_name = "z:", value = 84.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                direction_y = { ui_name = "y:", value = 0.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                strength = { value = 94.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                rgb = { r = 255.00, ui_format = "r&g&b", g = 251.00, ui_type = "color", b = 249.00 },
                direction_x = { ui_name = "x:", value = -95.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
            ...
            light_5 = { 
                ...
                rgb = { r = 255.00, ui_format = "r&g&b", g = 255.00, ui_type = "color", b = 255.00 },
            ...
            light_3 = { 
                ...
                direction_y = { ui_name = "y:", value = 0.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                strength = { value = 0.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                rgb = { r = 255.00, ui_format = "r&g&b", g = 216.00, ui_type = "color", b = 198.00 },
                direction_x = { ui_name = "x:", value = 0.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                order = { "rgb", "direction_x", "direction_y", "direction_z", "strength" }
            },
            light_4 = { 
            ...
            light_2 = { 
                ...
                direction_z = { ui_name = "z:", value = 7.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                direction_y = { ui_name = "y:", value = 0.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                strength = { value = 0.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                rgb = { r = 254.00, ui_format = "r&g&b", g = 250.00, ui_type = "color", b = 255.00 },
                direction_x = { ui_name = "x:", value = 0.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                order = { "rgb", "direction_x", "direction_y", "direction_z", "strength" }
            },
            order = { "light_1", "light_2", "light_3", "light_4", "light_5" }
        },
        lightMin = { ui_name = "最小:", precision = 2.00, value = 0.41, ui_type = "slider", min = 0.00, max = 2.00, step = 0.02 },
    ...
    depthLight = { 
        ...
        fps = { ui_name = "fps:", value = 15.00, ui_type = "slider", min = 0.00, max = 24.00, step = 1.00 },
        maskDebug = { 
        ...
        lightInfo = { 
            ...
            light_1 = { 
                ...
                radius = { ui_name = "半径", value = 94.00, ui_type = "slider", min = 0.00, max = 100.00, step = 1.00 },
                touchDepth = { 
                ...
                rgb = { r = 239.00, ui_format = "r&g&b", g = 237.00, ui_type = "color", b = 207.00 },
                pow = { ui_name = "衰减", precision = 2.00, value = 1.08, ui_type = "slider", min = 0.00, max = 5.00, step = 0.05 },
                strength = { value = 30.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                order = { "rgb", "position", "z", "strength", "pow", "radius", "follow", "touchDepth" },
                position = { ui_name = "位置:", y = 47.00, ui_format = "x&y", x = 60.00, ui_type = "position", min = 0.00, max = 100.00, precision = 2.00 }
            },
            light_5 = { 
            ...
            light_3 = { 
                ...
                rgb = { r = 97.00, ui_format = "r&g&b", g = 66.00, ui_type = "color", b = 39.00 },
                pow = { ui_name = "衰减", precision = 2.00, value = 5.00, ui_type = "slider", min = 0.00, max = 5.00, step = 0.05 },
                strength = { value = 0.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                order = { "rgb", "position", "z", "strength", "pow", "radius", "follow", "touchDepth" },
                position = { ui_name = "位置:", ui_format = "x&y", y = 59.96, x = 50.17, ui_type = "position", min = 0.00, max = 100.00, precision = 2.00 }
            },
            light_4 = { 
                ...
                rgb = { r = 255.00, ui_format = "r&g&b", g = 248.00, ui_type = "color", b = 222.00 },
                pow = { ui_name = "衰减", precision = 2.00, value = 5.00, ui_type = "slider", min = 0.00, max = 5.00, step = 0.05 },
                strength = { value = 0.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                order = { "rgb", "position", "z", "strength", "pow", "radius", "follow", "touchDepth" },
            ...
            light_2 = { 
                ...
                z = { ui_name = "深度:", value = 70.00, ui_type = "slider", min = 0.00, max = 100.00, step = 1.00 },
                radius = { ui_name = "半径", value = 67.00, ui_type = "slider", min = 0.00, max = 100.00, step = 1.00 },
                touchDepth = { 
                    ui_name_tw = "深度为z", ui_name = "深度为z", ui_type = "radioGroup", value = 2.00, ui_name_en = "Depth Z",
                    items = { 
                        { name_en = "使用图片的深度", name = "使用图片的深度", name_tw = "使用图片的深度" },
                ...
                rgb = { r = 255.00, ui_format = "r&g&b", g = 235.00, ui_type = "color", b = 222.00 },
                pow = { ui_name = "衰减", precision = 2.00, value = 2.25, ui_type = "slider", min = 0.00, max = 5.00, step = 0.05 },
                strength = { value = 29.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                order = { "rgb", "position", "z", "strength", "pow", "radius", "follow", "touchDepth" },
                position = { ui_name = "位置:", y = 50.00, ui_format = "x&y", x = 50.00, ui_type = "position", min = 0.00, max = 100.00, precision = 2.00 }
            },
            order = { "light_1", "light_2", "light_3", "light_4", "light_5" }
        ...
        ambient = { ui_name = "环境:", value = 94.00, ui_type = "slider", min = 0.00, max = 100.00, step = 1.00 },
        showPoint = { 
        ...
        blur = { ui_name = "模糊程度:", precision = 2.00, value = 2.53, ui_type = "slider", min = 0.00, max = 5.00, step = 0.05 },
        filtertype = { 
    ...
    hue = { h = 18.00, min = 0.00, step = 1.00, s = 41.41, ui_name = "色调", value = 5.00, ui_type = "slider", v = 94.11, max = 100.00, fix_max = 330.00 },
    effect_check = { 
    ...
    editType = { 
        ui_type = "radioGroup", value = 1.00, ui_name = "当前选择类型",
        items = { 
            { name = "人脸阴影" },
            { name = "霓虹光" },
            { name = "轮廓光" },
    ...
    rim = { 
        ...
        strength = { value = 28.40, ui_type = "slider", min = 0.00, max = 100.00, step = 1.00 },
        debug = { 
            ui_name_tw = "方式", ui_name = "方式", ui_type = "radioGroup", value = 1.00, ui_name_en = "Methods",
            items = { 
                { name_en = "分割", name = "分割", name_tw = "分割" },
    ...
    totalColor = { h = 56.25, s = 13.39, edited = false, b = 207.00, ui_format = "r&g&b", r = 239.00, g = 237.00, v = 93.73, ui_type = "color" },
    ...
    faceLight = { 
        ...
        lightInfo = { 
            ...
            light_1 = { 
                ...
                direction_y = { ui_name = "y:", value = 0.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                strength = { value = 0.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                rgb = { b = 24.00, ui_format = "r&g&b", g = 193.00, ui_type = "color", r = 208.00 },
                direction_x = { ui_name = "x:", value = 0.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                order = { "rgb", "direction_x", "direction_y", "direction_z", "strength" }
            },
            light_5 = { 
                ...
                direction_y = { ui_name = "y:", value = 0.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                strength = { value = 0.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                rgb = { b = 255.00, ui_format = "r&g&b", g = 255.00, ui_type = "color", r = 255.00 },
                direction_x = { ui_name = "x:", value = 0.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                order = { "rgb", "direction_x", "direction_y", "direction_z", "strength" }
            },
            light_3 = { 
