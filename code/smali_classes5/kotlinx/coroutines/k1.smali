...
.method static constructor <clinit>()V
    ...
    sput-object v2, Lkotlinx/coroutines/k1;->f:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Lkotlinx/coroutines/k1;->g:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method public static final synthetic Y(Lkotlinx/coroutines/k1;)Z
    .locals 0

    .line 1
    invoke-direct {p0}, Lkotlinx/coroutines/k1;->c()Z
...
.method public static final synthetic a0(Lkotlinx/coroutines/k1;Z)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lkotlinx/coroutines/k1;->k0(Z)V
...
.method private final b0()V
    ...
    .line 3
    sget-object v0, Lkotlinx/coroutines/k1;->f:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;

    const/4 v1, 0x0

    invoke-static {}, Lkotlinx/coroutines/n1;->c()Lkotlinx/coroutines/internal/c0;
    ...
    .line 9
    sget-object v2, Lkotlinx/coroutines/k1;->f:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method private final c0()Ljava/lang/Runnable;
    ...
    .line 4
    sget-object v3, Lkotlinx/coroutines/internal/p;->s:Lkotlinx/coroutines/internal/c0;
    ...
    invoke-virtual {v1}, Lkotlinx/coroutines/internal/p;->k()Lkotlinx/coroutines/internal/p;
...
.method private final e0(Ljava/lang/Runnable;)Z
    ...
    .line 6
    :cond_4
    sget-object v1, Lkotlinx/coroutines/k1;->f:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;

    invoke-virtual {v3}, Lkotlinx/coroutines/internal/p;->k()Lkotlinx/coroutines/internal/p;
    ...
    .line 12
    sget-object v3, Lkotlinx/coroutines/k1;->f:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method private final f0()V
    ...
    invoke-virtual {v2}, Lkotlinx/coroutines/internal/k0;->m()Lkotlinx/coroutines/internal/l0;
    ...
    .line 3
    invoke-virtual {p0, v0, v1, v2}, Lkotlinx/coroutines/l1;->U(JLkotlinx/coroutines/k1$c;)V
...
.method private final i0(JLkotlinx/coroutines/k1$c;)I
    .locals 3
    ...
    .line 3
    :cond_1
    sget-object v0, Lkotlinx/coroutines/k1;->g:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    .line 5
    :goto_0
    invoke-virtual {p3, p1, p2, v0, p0}, Lkotlinx/coroutines/k1$c;->p(JLkotlinx/coroutines/k1$d;Lkotlinx/coroutines/k1;)I
...
.method private final l0(Lkotlinx/coroutines/k1$c;)Z
    .locals 1
...
.method protected J()J
    ...
    .line 1
    invoke-super {p0}, Lkotlinx/coroutines/j1;->J()J
    ...
    invoke-virtual {v0}, Lkotlinx/coroutines/internal/p;->h()Z
    ...
    .line 5
    iget-wide v0, v0, Lkotlinx/coroutines/k1$c;->c:J
    ...
    invoke-interface {v4}, Lkotlinx/coroutines/l3;->b()J
    ...
    invoke-static {v0, v1, v2, v3}, Lkotlin/g2/o;->o(JJ)J
...
.method protected M()Z
    ...
    .line 1
    invoke-virtual {p0}, Lkotlinx/coroutines/j1;->O()Z
...
.method public P()J
    ...
    .line 1
    invoke-virtual {p0}, Lkotlinx/coroutines/j1;->Q()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lkotlinx/coroutines/k1;->J()J
    ...
    invoke-interface {v1}, Lkotlinx/coroutines/l3;->b()J
    ...
    .line 8
    invoke-virtual {v3, v1, v2}, Lkotlinx/coroutines/k1$c;->s(J)Z
    ...
    .line 9
    invoke-direct {p0, v3}, Lkotlinx/coroutines/k1;->e0(Ljava/lang/Runnable;)Z
    ...
    .line 10
    invoke-virtual {v0, v6}, Lkotlinx/coroutines/internal/k0;->k(I)Lkotlinx/coroutines/internal/l0;
    ...
    .line 15
    :cond_5
    invoke-direct {p0}, Lkotlinx/coroutines/k1;->c0()Ljava/lang/Runnable;
...
.method public b(JLkotlinx/coroutines/m;)V
    ...
    .line 1
    invoke-static {p1, p2}, Lkotlinx/coroutines/n1;->f(J)J
    ...
    invoke-direct {v2, p0, p1, p2, p3}, Lkotlinx/coroutines/k1$a;-><init>(Lkotlinx/coroutines/k1;JLkotlinx/coroutines/m;)V

    .line 4
    invoke-static {p3, v2}, Lkotlinx/coroutines/p;->a(Lkotlinx/coroutines/m;Lkotlinx/coroutines/f1;)V

    .line 5
    invoke-virtual {p0, v0, v1, v2}, Lkotlinx/coroutines/k1;->h0(JLkotlinx/coroutines/k1$c;)V
...
.method public final d0(Ljava/lang/Runnable;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lkotlinx/coroutines/k1;->e0(Ljava/lang/Runnable;)Z
    ...
    .line 2
    invoke-virtual {p0}, Lkotlinx/coroutines/l1;->V()V
    ...
    invoke-virtual {v0, p1}, Lkotlinx/coroutines/k1;->d0(Ljava/lang/Runnable;)V
...
.method public final h0(JLkotlinx/coroutines/k1$c;)V
    .locals 2
    ...
    .line 1
    invoke-direct {p0, p1, p2, p3}, Lkotlinx/coroutines/k1;->i0(JLkotlinx/coroutines/k1$c;)I
    ...
    .line 3
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lkotlinx/coroutines/l1;->U(JLkotlinx/coroutines/k1$c;)V

    goto :goto_0

    .line 4
    :cond_2
    invoke-direct {p0, p3}, Lkotlinx/coroutines/k1;->l0(Lkotlinx/coroutines/k1$c;)Z
...
.method protected final j0(JLjava/lang/Runnable;)Lkotlinx/coroutines/f1;
    .locals 3
...
.method protected shutdown()V
    ...
    .line 2
    invoke-direct {p0, v0}, Lkotlinx/coroutines/k1;->k0(Z)V

    .line 3
    invoke-direct {p0}, Lkotlinx/coroutines/k1;->b0()V
    ...
    .line 5
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/k1;->f0()V
...
.method public final u(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Runnable;)V
    ...
    .line 1
    invoke-virtual {p0, p2}, Lkotlinx/coroutines/k1;->d0(Ljava/lang/Runnable;)V
