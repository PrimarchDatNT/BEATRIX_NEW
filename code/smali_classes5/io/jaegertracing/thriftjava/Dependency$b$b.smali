.class public Lio/jaegertracing/thriftjava/Dependency$b$b;
...
.method public constructor <init>(Ljava/lang/String;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 2
    iput-object p1, p0, Lio/jaegertracing/thriftjava/Dependency$b$b;->a:Ljava/lang/String;
...
# virtual methods
.method public a()Lio/jaegertracing/thriftjava/Dependencies;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/apache/thrift/TException;
    ...
    .line 4
    new-instance v1, Lio/jaegertracing/thriftjava/Dependency$e;

    invoke-direct {v1, v0}, Lio/jaegertracing/thriftjava/Dependency$e;-><init>(Lorg/apache/thrift/protocol/TProtocol;)V

    invoke-virtual {v1}, Lio/jaegertracing/thriftjava/Dependency$e;->l()Lio/jaegertracing/thriftjava/Dependencies;
...
.method public bridge synthetic getResult()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lio/jaegertracing/thriftjava/Dependency$b$b;->a()Lio/jaegertracing/thriftjava/Dependencies;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    .line 3
    iget-object v1, p0, Lio/jaegertracing/thriftjava/Dependency$b$b;->a:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lio/jaegertracing/thriftjava/Dependency$getDependenciesForTrace_args;->setTraceId(Ljava/lang/String;)Lio/jaegertracing/thriftjava/Dependency$getDependenciesForTrace_args;

    .line 4
    invoke-virtual {v0, p1}, Lio/jaegertracing/thriftjava/Dependency$getDependenciesForTrace_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
