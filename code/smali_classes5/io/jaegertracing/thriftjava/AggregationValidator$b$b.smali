.class public Lio/jaegertracing/thriftjava/AggregationValidator$b$b;
...
.method public constructor <init>(Ljava/lang/String;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    iput-object p1, p0, Lio/jaegertracing/thriftjava/AggregationValidator$b$b;->a:Ljava/lang/String;
...
# virtual methods
.method public a()Lio/jaegertracing/thriftjava/ValidateTraceResponse;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/apache/thrift/TException;
    ...
    new-instance v1, Lio/jaegertracing/thriftjava/AggregationValidator$e;

    invoke-direct {v1, v0}, Lio/jaegertracing/thriftjava/AggregationValidator$e;-><init>(Lorg/apache/thrift/protocol/TProtocol;)V

    invoke-virtual {v1}, Lio/jaegertracing/thriftjava/AggregationValidator$e;->l()Lio/jaegertracing/thriftjava/ValidateTraceResponse;
...
.method public bridge synthetic getResult()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lio/jaegertracing/thriftjava/AggregationValidator$b$b;->a()Lio/jaegertracing/thriftjava/ValidateTraceResponse;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lio/jaegertracing/thriftjava/AggregationValidator$b$b;->a:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lio/jaegertracing/thriftjava/AggregationValidator$validateTrace_args;->setTraceId(Ljava/lang/String;)Lio/jaegertracing/thriftjava/AggregationValidator$validateTrace_args;

    invoke-virtual {v0, p1}, Lio/jaegertracing/thriftjava/AggregationValidator$validateTrace_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
