.class public Lio/jaegertracing/agent/thrift/Agent$g$b;
...
.method public b(Lio/jaegertracing/agent/thrift/Agent$f;Lio/jaegertracing/agent/thrift/Agent$emitZipkinBatch_args;)Lorg/apache/thrift/TBase;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TI;",
    ...
    invoke-interface {p1, p2}, Lio/jaegertracing/agent/thrift/Agent$f;->d(Ljava/util/List;)V
...
.method public bridge synthetic getEmptyArgsInstance()Lorg/apache/thrift/TBase;
    ...
    .line 1
    invoke-virtual {p0}, Lio/jaegertracing/agent/thrift/Agent$g$b;->a()Lio/jaegertracing/agent/thrift/Agent$emitZipkinBatch_args;
...
.method public bridge synthetic getResult(Ljava/lang/Object;Lorg/apache/thrift/TBase;)Lorg/apache/thrift/TBase;
    ...
    invoke-virtual {p0, p1, p2}, Lio/jaegertracing/agent/thrift/Agent$g$b;->b(Lio/jaegertracing/agent/thrift/Agent$f;Lio/jaegertracing/agent/thrift/Agent$emitZipkinBatch_args;)Lorg/apache/thrift/TBase;
