.class public Lio/jaegertracing/crossdock/thrift/TracedService$d$a;
...
# virtual methods
.method public a()Lio/jaegertracing/crossdock/thrift/TracedService$joinTrace_args;
    .locals 1
...
.method public b(Lio/jaegertracing/crossdock/thrift/TracedService$c;Lio/jaegertracing/crossdock/thrift/TracedService$joinTrace_args;Lorg/apache/thrift/async/AsyncMethodCallback;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TI;",
    ...
    invoke-interface {p1, p2, p3}, Lio/jaegertracing/crossdock/thrift/TracedService$c;->h(Lio/jaegertracing/crossdock/thrift/JoinTraceRequest;Lorg/apache/thrift/async/AsyncMethodCallback;)V
...
.method public bridge synthetic getEmptyArgsInstance()Lorg/apache/thrift/TBase;
    ...
    .line 1
    invoke-virtual {p0}, Lio/jaegertracing/crossdock/thrift/TracedService$d$a;->a()Lio/jaegertracing/crossdock/thrift/TracedService$joinTrace_args;
...
.method public getResultHandler(Lorg/apache/thrift/server/AbstractNonblockingServer$AsyncFrameBuffer;I)Lorg/apache/thrift/async/AsyncMethodCallback;
    ...
    .line 1
    new-instance v0, Lio/jaegertracing/crossdock/thrift/TracedService$d$a$a;

    invoke-direct {v0, p0, p0, p1, p2}, Lio/jaegertracing/crossdock/thrift/TracedService$d$a$a;-><init>(Lio/jaegertracing/crossdock/thrift/TracedService$d$a;Lorg/apache/thrift/AsyncProcessFunction;Lorg/apache/thrift/server/AbstractNonblockingServer$AsyncFrameBuffer;I)V
...
.method public bridge synthetic start(Ljava/lang/Object;Lorg/apache/thrift/TBase;Lorg/apache/thrift/async/AsyncMethodCallback;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lio/jaegertracing/crossdock/thrift/TracedService$d$a;->b(Lio/jaegertracing/crossdock/thrift/TracedService$c;Lio/jaegertracing/crossdock/thrift/TracedService$joinTrace_args;Lorg/apache/thrift/async/AsyncMethodCallback;)V
