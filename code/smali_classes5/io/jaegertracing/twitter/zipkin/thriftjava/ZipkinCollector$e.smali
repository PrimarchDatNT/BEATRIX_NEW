.class public Lio/jaegertracing/twitter/zipkin/thriftjava/ZipkinCollector$e;
.super Lorg/apache/thrift/TServiceClient;
.source "ZipkinCollector.java"

# interfaces
.implements Lio/jaegertracing/twitter/zipkin/thriftjava/ZipkinCollector$f;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/jaegertracing/twitter/zipkin/thriftjava/ZipkinCollector$e$a;
    }
.end annotation
...
.method public f(Ljava/util/List;)Ljava/util/List;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lio/jaegertracing/twitter/zipkin/thriftjava/ZipkinCollector$e;->m(Ljava/util/List;)V

    .line 2
    invoke-virtual {p0}, Lio/jaegertracing/twitter/zipkin/thriftjava/ZipkinCollector$e;->l()Ljava/util/List;
...
.method public l()Ljava/util/List;
    ...
    .line 3
    invoke-virtual {v0}, Lio/jaegertracing/twitter/zipkin/thriftjava/ZipkinCollector$submitZipkinBatch_result;->isSetSuccess()Z
    ...
    .line 4
    iget-object v0, v0, Lio/jaegertracing/twitter/zipkin/thriftjava/ZipkinCollector$submitZipkinBatch_result;->success:Ljava/util/List;
    ...
    const-string v2, "submitZipkinBatch failed: unknown result"
...
.method public m(Ljava/util/List;)V
    ...
    .line 2
    invoke-virtual {v0, p1}, Lio/jaegertracing/twitter/zipkin/thriftjava/ZipkinCollector$submitZipkinBatch_args;->setSpans(Ljava/util/List;)Lio/jaegertracing/twitter/zipkin/thriftjava/ZipkinCollector$submitZipkinBatch_args;

    const-string p1, "submitZipkinBatch"
