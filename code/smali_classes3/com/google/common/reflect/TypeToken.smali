...
# instance fields
.field private transient covariantTypeResolver:Lcom/google/common/reflect/l;
    .annotation runtime Ln/b/a/a/a/g;
    .end annotation
.end field

.field private transient invariantTypeResolver:Lcom/google/common/reflect/l;
    .annotation runtime Ln/b/a/a/a/g;
    .end annotation
.end field
...
.method protected constructor <init>(Ljava/lang/Class;)V
    ...
    invoke-super {p0}, Lcom/google/common/reflect/j;->capture()Ljava/lang/reflect/Type;
    ...
    :cond_0
    invoke-static {p1}, Lcom/google/common/reflect/l;->d(Ljava/lang/reflect/Type;)Lcom/google/common/reflect/l;

    move-result-object p1

    invoke-virtual {p1, v0}, Lcom/google/common/reflect/l;->j(Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;
...
.method static synthetic access$000(Lcom/google/common/reflect/TypeToken;)Lcom/google/common/reflect/l;
    .locals 0

    invoke-direct {p0}, Lcom/google/common/reflect/TypeToken;->getCovariantTypeResolver()Lcom/google/common/reflect/l;
...
.method static synthetic access$100(Lcom/google/common/reflect/TypeToken;)Lcom/google/common/reflect/l;
    .locals 0

    invoke-direct {p0}, Lcom/google/common/reflect/TypeToken;->getInvariantTypeResolver()Lcom/google/common/reflect/l;
...
.method private getArraySupertype(Ljava/lang/Class;)Lcom/google/common/reflect/TypeToken;
    ...
    invoke-static {v0, v1, p1, p0}, Lcom/google/common/base/t;->Z(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private getCovariantTypeResolver()Lcom/google/common/reflect/l;
    .locals 1

    iget-object v0, p0, Lcom/google/common/reflect/TypeToken;->covariantTypeResolver:Lcom/google/common/reflect/l;

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/google/common/reflect/TypeToken;->runtimeType:Ljava/lang/reflect/Type;

    invoke-static {v0}, Lcom/google/common/reflect/l;->d(Ljava/lang/reflect/Type;)Lcom/google/common/reflect/l;

    move-result-object v0

    iput-object v0, p0, Lcom/google/common/reflect/TypeToken;->covariantTypeResolver:Lcom/google/common/reflect/l;

    :cond_0
    return-object v0
.end method

.method private getInvariantTypeResolver()Lcom/google/common/reflect/l;
    .locals 1

    iget-object v0, p0, Lcom/google/common/reflect/TypeToken;->invariantTypeResolver:Lcom/google/common/reflect/l;

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/google/common/reflect/TypeToken;->runtimeType:Ljava/lang/reflect/Type;

    invoke-static {v0}, Lcom/google/common/reflect/l;->f(Ljava/lang/reflect/Type;)Lcom/google/common/reflect/l;

    move-result-object v0

    iput-object v0, p0, Lcom/google/common/reflect/TypeToken;->invariantTypeResolver:Lcom/google/common/reflect/l;
...
.method private getRawTypes()Lcom/google/common/collect/ImmutableSet;
    ...
    invoke-virtual {v1, v2}, Lcom/google/common/reflect/n;->a([Ljava/lang/reflect/Type;)V
...
.method private isOwnedBySubtypeOf(Ljava/lang/reflect/Type;)Z
    ...
    invoke-virtual {v0}, Lcom/google/common/collect/d0;->iterator()Ljava/util/Iterator;
...
.method private isSubtypeOfParameterizedType(Ljava/lang/reflect/ParameterizedType;)Z
    ...
    invoke-virtual {v4, v5}, Lcom/google/common/reflect/l;->j(Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;
...
.method private isWrapper()Z
    ...
    invoke-static {}, Lcom/google/common/primitives/f;->c()Ljava/util/Set;
...
.method private resolveSupertype(Ljava/lang/reflect/Type;)Lcom/google/common/reflect/TypeToken;
    ...
    invoke-virtual {v0, p1}, Lcom/google/common/reflect/l;->j(Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;
    ...
    iput-object v0, p1, Lcom/google/common/reflect/TypeToken;->covariantTypeResolver:Lcom/google/common/reflect/l;

    iget-object v0, p0, Lcom/google/common/reflect/TypeToken;->invariantTypeResolver:Lcom/google/common/reflect/l;

    iput-object v0, p1, Lcom/google/common/reflect/TypeToken;->invariantTypeResolver:Lcom/google/common/reflect/l;
...
.method private resolveTypeArgsForSubclass(Ljava/lang/Class;)Ljava/lang/reflect/Type;
    ...
    new-instance v1, Lcom/google/common/reflect/l;

    invoke-direct {v1}, Lcom/google/common/reflect/l;-><init>()V

    iget-object v2, p0, Lcom/google/common/reflect/TypeToken;->runtimeType:Ljava/lang/reflect/Type;

    invoke-virtual {v1, v0, v2}, Lcom/google/common/reflect/l;->n(Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;)Lcom/google/common/reflect/l;
...
.method public final getSubtype(Ljava/lang/Class;)Lcom/google/common/reflect/TypeToken;
    ...
    invoke-static {v0, v1, p1, p0}, Lcom/google/common/base/t;->y(ZLjava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public final unwrap()Lcom/google/common/reflect/TypeToken;
    ...
    invoke-static {v0}, Lcom/google/common/primitives/f;->e(Ljava/lang/Class;)Ljava/lang/Class;
...
.method public final where(Lcom/google/common/reflect/k;Lcom/google/common/reflect/TypeToken;)Lcom/google/common/reflect/TypeToken;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<X:",
    ...
    invoke-direct {v1, p1}, Lcom/google/common/reflect/l$d;-><init>(Ljava/lang/reflect/TypeVariable;)V
    ...
    invoke-virtual {v0, p1}, Lcom/google/common/reflect/l;->o(Ljava/util/Map;)Lcom/google/common/reflect/l;
...
.method public final where(Lcom/google/common/reflect/k;Ljava/lang/Class;)Lcom/google/common/reflect/TypeToken;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<X:",
    ...
    invoke-virtual {p0, p1, p2}, Lcom/google/common/reflect/TypeToken;->where(Lcom/google/common/reflect/k;Lcom/google/common/reflect/TypeToken;)Lcom/google/common/reflect/TypeToken;
...
.method public final wrap()Lcom/google/common/reflect/TypeToken;
    ...
    invoke-static {v0}, Lcom/google/common/primitives/f;->f(Ljava/lang/Class;)Ljava/lang/Class;
