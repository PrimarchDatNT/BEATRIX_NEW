...
uniform  sampler2D mt_mask_5;
uniform  sampler2D mt_mask_6;
uniform float alpha;
...
void main()
{
    ...
    temp = texture2D(mt_mask_5, mt_index);
    temp.r=temp.r/temp.a;
    temp.g=temp.g/temp.a;
    temp.b=temp.b/temp.a;
    tempColor.r = mix(tempColor.r,texture2D( mt_mask_6, vec2(temp.r,tempColor.r)).r, temp.a);
    tempColor.g = mix(tempColor.g,texture2D( mt_mask_6, vec2(temp.g,tempColor.g)).g, temp.a);
    tempColor.b = mix(tempColor.b,texture2D( mt_mask_6, vec2(temp.b,tempColor.b)).b, temp.a);
