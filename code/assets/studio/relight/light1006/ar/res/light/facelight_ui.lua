...
ui = { 
    totalColor = { s = 100.00, ui_format = "r&g&b", b = 0.00, v = 47.06, r = 120.00, edited = false, g = 90.00, h = 45.00, ui_type = "color" },
    select_light = { 
    ...
    shadow = { 
        ...
        lightInfo = { 
            ...
            light_1 = { 
                ...
                rgb = { ui_format = "r&g&b", g = 249.00, b = 58.00, ui_type = "color", r = 230.00 },
    ...
    faceLight = { 
        ...
        lightInfo = { 
            ...
            light_5 = { 
                ui_common = false, ui_type = "groupbox", materialKey = "u_directionLightDirection[4]", ui_name = "平行光5:", materialColorKey = "u_directionLightColor[4]",
                rgb = { ui_format = "r&g&b", g = 33.00, r = 30.00, ui_type = "color", b = 255.00 },
            ...
            light_3 = { 
                ui_common = false, ui_type = "groupbox", materialKey = "u_directionLightDirection[2]", ui_name = "平行光3:", materialColorKey = "u_directionLightColor[2]",
                rgb = { ui_format = "r&g&b", g = 255.00, r = 255.00, ui_type = "color", b = 255.00 },
                direction_z = { ui_type = "slider", valueFactor = 100.00, max = 300.00, ui_name = "z:", min = -300.00, step = 1.00, value = -4.00 },
                order = { "rgb", "direction_x", "direction_y", "direction_z", "strength" },
                direction_y = { ui_type = "slider", valueFactor = 100.00, max = 300.00, ui_name = "y:", min = -300.00, step = 1.00, value = 8.00 },
                direction_x = { ui_type = "slider", valueFactor = 100.00, max = 300.00, ui_name = "x:", min = -300.00, step = 1.00, value = -300.00 },
                strength = { max = 200.00, value = 39.00, min = 0.00, step = 1.00, ui_type = "slider" }
            },
            light_2 = { 
                ui_common = false, ui_type = "groupbox", materialKey = "u_directionLightDirection[1]", ui_name = "平行光2:", materialColorKey = "u_directionLightColor[1]",
                rgb = { ui_format = "r&g&b", g = 255.00, r = 255.00, ui_type = "color", b = 255.00 },
                direction_z = { ui_type = "slider", valueFactor = 100.00, max = 300.00, ui_name = "z:", min = -300.00, step = 1.00, value = 108.00 },
                order = { "rgb", "direction_x", "direction_y", "direction_z", "strength" },
                direction_y = { ui_type = "slider", valueFactor = 100.00, max = 300.00, ui_name = "y:", min = -300.00, step = 1.00, value = -300.00 },
                direction_x = { ui_type = "slider", valueFactor = 100.00, max = 300.00, ui_name = "x:", min = -300.00, step = 1.00, value = -300.00 },
                strength = { max = 200.00, value = 47.00, min = 0.00, step = 1.00, ui_type = "slider" }
            },
            light_1 = { 
                ui_common = false, ui_type = "groupbox", materialKey = "u_directionLightDirection[0]", ui_name = "平行光1:", materialColorKey = "u_directionLightColor[0]",
                rgb = { ui_format = "r&g&b", g = 90.00, r = 120.00, ui_type = "color", b = 0.00 },
                direction_z = { ui_type = "slider", valueFactor = 100.00, max = 300.00, ui_name = "z:", min = -300.00, step = 1.00, value = 171.00 },
                order = { "rgb", "direction_x", "direction_y", "direction_z", "strength" },
                direction_y = { ui_type = "slider", valueFactor = 100.00, max = 300.00, ui_name = "y:", min = -300.00, step = 1.00, value = 84.00 },
                direction_x = { ui_type = "slider", valueFactor = 100.00, max = 300.00, ui_name = "x:", min = -300.00, step = 1.00, value = 300.00 },
                strength = { max = 200.00, value = 115.00, min = 0.00, step = 1.00, ui_type = "slider" }
            },
            light_4 = { 
                ui_common = false, ui_type = "groupbox", materialKey = "u_directionLightDirection[3]", ui_name = "平行光4:", materialColorKey = "u_directionLightColor[3]",
                rgb = { ui_format = "r&g&b", g = 33.00, r = 30.00, ui_type = "color", b = 255.00 },
    ...
    depthLight = { 
        ...
        ambient = { value = 79.00, max = 100.00, ui_name = "环境:", min = 0.00, step = 1.00, ui_type = "slider" },
        lightInfo = { 
