...
ui = { 
    shadow = { 
        ...
        shadowColor = { b = 85.00, ui_format = "r&g&b", g = 102.00, ui_name = "阴影颜色", r = 131.00, ui_type = "color" },
        lightMax = { ui_name = "最大:", precision = 2.00, value = 0.35, ui_type = "slider", min = 0.00, max = 2.00, step = 0.02 },
        order = { "blur", "erosion", "lightMax", "lightMin", "shadowColor", "lightInfo" },
        blur = { ui_name = "模糊程度:", precision = 2.00, value = 3.71, ui_type = "slider", min = 0.00, max = 5.00, step = 0.05 },
        lightInfo = { 
            ...
            light_1 = { 
                ...
                direction_z = { ui_name = "z:", value = 36.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                direction_y = { ui_name = "y:", value = -33.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                strength = { value = 70.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                rgb = { r = 255.00, ui_format = "r&g&b", ui_type = "color", g = 233.00, b = 222.00 },
            ...
            light_3 = { 
                ...
                direction_y = { ui_name = "y:", value = 0.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                strength = { value = 0.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                rgb = { r = 255.00, ui_format = "r&g&b", ui_type = "color", g = 222.00, b = 198.00 },
                direction_x = { ui_name = "x:", value = 0.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                order = { "rgb", "direction_x", "direction_y", "direction_z", "strength" }
            },
            light_4 = { 
            ...
            light_2 = { 
                ...
                direction_y = { ui_name = "y:", value = 0.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                strength = { value = 0.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                rgb = { r = 255.00, ui_format = "r&g&b", ui_type = "color", g = 254.00, b = 255.00 },
                direction_x = { ui_name = "x:", value = 0.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                order = { "rgb", "direction_x", "direction_y", "direction_z", "strength" }
            },
            order = { "light_1", "light_2", "light_3", "light_4", "light_5" }
        },
        lightMin = { ui_name = "最小:", precision = 2.00, value = 0.56, ui_type = "slider", min = 0.00, max = 2.00, step = 0.02 },
    ...
    depthLight = { 
        ...
        maskDebug = { 
            ...
            method = { 
                ui_name_tw = "方式", ui_name = "方式", ui_type = "radioGroup", value = 2.00, ui_name_en = "Methods",
                items = { 
        ...
        lightInfo = { 
            ...
            light_1 = { 
                ...
                rgb = { r = 239.00, ui_format = "r&g&b", ui_type = "color", g = 237.00, b = 207.00 },
                pow = { ui_name = "衰减", precision = 2.00, value = 2.82, ui_type = "slider", min = 0.00, max = 5.00, step = 0.05 },
                strength = { value = 23.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                order = { "rgb", "position", "z", "strength", "pow", "radius", "follow", "touchDepth" },
                position = { y = 46.00, x = 47.00, min = 0.00, precision = 2.00, ui_type = "position", ui_name = "位置:", max = 100.00, ui_format = "x&y" }
            },
            light_5 = { 
            ...
            light_3 = { 
                ...
                rgb = { r = 97.00, ui_format = "r&g&b", ui_type = "color", g = 66.00, b = 39.00 },
                pow = { ui_name = "衰减", precision = 2.00, value = 5.00, ui_type = "slider", min = 0.00, max = 5.00, step = 0.05 },
                strength = { value = 0.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                order = { "rgb", "position", "z", "strength", "pow", "radius", "follow", "touchDepth" },
                position = { ui_name = "位置:", y = 63.96, ui_format = "x&y", x = 50.17, ui_type = "position", min = 0.00, max = 100.00, precision = 2.00 }
            },
            light_4 = { 
                ...
                rgb = { r = 255.00, ui_format = "r&g&b", ui_type = "color", g = 231.00, b = 190.00 },
                pow = { ui_name = "衰减", precision = 2.00, value = 5.00, ui_type = "slider", min = 0.00, max = 5.00, step = 0.05 },
                strength = { value = 0.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                order = { "rgb", "position", "z", "strength", "pow", "radius", "follow", "touchDepth" },
                position = { ui_name = "位置:", ui_format = "x&y", y = 4.00, x = 50.00, ui_type = "position", min = 0.00, max = 100.00, precision = 2.00 }
            },
            light_2 = { 
                ...
                rgb = { r = 255.00, ui_format = "r&g&b", ui_type = "color", g = 235.00, b = 222.00 },
                pow = { ui_name = "衰减", precision = 2.00, value = 5.00, ui_type = "slider", min = 0.00, max = 5.00, step = 0.05 },
                strength = { value = 0.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                order = { "rgb", "position", "z", "strength", "pow", "radius", "follow", "touchDepth" },
                position = { ui_name = "位置:", y = 63.68, ui_format = "x&y", x = 51.48, ui_type = "position", min = 0.00, max = 100.00, precision = 2.00 }
            },
            order = { "light_1", "light_2", "light_3", "light_4", "light_5" }
        },
        filtertype = { 
            ...
            items = { 
                ...
                { name_en = "Darken", lutPath = "PSBlend/BlendDarken.jpg", name_tw = "變暗", name = "变暗" },
                { name_en = "Multiply", lutPath = "PSBlend/BlendMultiply.jpg", name_tw = "色彩增值", name = "正片叠底" },
                { name_en = "Color burn", lutPath = "PSBlend/BlendColorBurn.jpg", name_tw = "顏色加深", name = "颜色加深" },
                { name_en = "Linear burn", lutPath = "PSBlend/BlendLinearBurn.jpg", name_tw = "線性加深", name = "线性加深" },
                { name_en = "Dark", lutPath = "PSBlend/BlendDarkerColor.jpg", name_tw = "深色", name = "深色" },
                { name_en = "Lighten", lutPath = "PSBlend/BlendLighten.jpg", name_tw = "變亮", name = "变亮" },
                { name_en = "Screen", lutPath = "PSBlend/BlendScreen.jpg", name_tw = "濾色", name = "滤色" },
                { name_en = "Color dodge", lutPath = "PSBlend/BlendColorDodge.jpg", name_tw = "顏色減淡", name = "颜色减淡" },
                { name_en = "Linear dodge (Add)", lutPath = "PSBlend/BlendLinearDodge.jpg", name_tw = "線性減淡 (增加)", name = "线性减淡(添加)" },
                { name_en = "Light", lutPath = "PSBlend/BlendLighterColor.jpg", name_tw = "淺色", name = "浅色" },
                { name_en = "Overlay", lutPath = "PSBlend/BlendOverlay.jpg", name_tw = "疊加", name = "叠加" },
                { name_en = "Soft light", lutPath = "PSBlend/BlendSoftLight.jpg", name_tw = "柔光", name = "柔光" },
                { name_en = "Hard light", lutPath = "PSBlend/BlendHardLight.jpg", name_tw = "強光", name = "强光" },
                { name_en = "Vivid light", lutPath = "PSBlend/BlendVividLight.jpg", name_tw = "亮光", name = "亮光" },
                { name_en = "Linear light", lutPath = "PSBlend/BlendLinearLight.jpg", name_tw = "線性光", name = "线性光" },
                { name_en = "Pin light", lutPath = "PSBlend/BlendPinLight.jpg", name_tw = "點光", name = "点光" },
                { name_en = "Hard mix", lutPath = "PSBlend/BlendHardMix.jpg", name_tw = "實色疊印混合", name = "实色混合" },
                { name_en = "Difference", lutPath = "PSBlend/BlendDifference.jpg", name_tw = "差異化", name = "差值" },
                { name_en = "Exclusion", lutPath = "PSBlend/BlendExclusion.jpg", name_tw = "排除", name = "排除" },
                { name_en = "Subtract", lutPath = "PSBlend/BlendSubtract.jpg", name_tw = "相減", name = "减去" },
                { name_en = "Divide", lutPath = "PSBlend/BlendDivide.jpg", name_tw = "分割", name = "划分" }
            }
        },
        order = { "ambient", "maskDebug", "debug", "showPoint", "filtertype", "blur", "mask_animation", "fps", "select_light", "lightInfo", "pointDebug" }
    },
    hue = { h = 201.60, min = 0.00, step = 1.00, s = 41.41, ui_name = "色调", value = 56.00, ui_type = "slider", v = 94.11, max = 100.00, fix_max = 330.00 },
    effect_check = { 
    ...
    editType = { 
        ui_type = "radioGroup", value = 4.00, ui_name = "当前选择类型",
        items = { 
            { name = "人脸阴影" },
            { name = "霓虹光" },
            { name = "轮廓光" },
    ...
    rim = { 
        ...
        strength = { value = 49.68, ui_type = "slider", min = 0.00, max = 100.00, step = 1.00 },
        maskDebug = { 
            ui_name = "mask调整", ui_type = "groupbox",
    ...
    totalColor = { h = 56.25, s = 13.39, edited = false, r = 239.00, ui_format = "r&g&b", b = 207.00, g = 237.00, v = 93.73, ui_type = "color" },
    ...
    faceLight = { 
        ...
        blur = { ui_name = "模糊程度:", precision = 2.00, value = 3.82, ui_type = "slider", min = 0.00, max = 5.00, step = 0.00 },
        filtertype = { 
            ui_name = "背景叠加模式", value = 1.00, ui_type = "combox",
            items = { 
                { name = "通用" },
        ...
        lightInfo = { 
            ...
            light_1 = { 
                ui_common = false, materialColorKey = "u_directionLightColor[0]", materialKey = "u_directionLightDirection[0]", ui_type = "groupbox", ui_name = "平行光1:",
                direction_z = { ui_name = "z:", value = 46.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                direction_y = { ui_name = "y:", value = 49.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                strength = { value = 0.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
                rgb = { b = 24.00, ui_format = "r&g&b", ui_type = "color", g = 193.00, r = 208.00 },
                direction_x = { ui_name = "x:", value = 57.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                order = { "rgb", "direction_x", "direction_y", "direction_z", "strength" }
            },
            light_5 = { 
                ui_common = false, materialColorKey = "u_directionLightColor[4]", materialKey = "u_directionLightDirection[4]", ui_type = "groupbox", ui_name = "平行光5:",
                direction_z = { ui_name = "z:", value = 100.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                direction_y = { ui_name = "y:", value = 0.00, valueFactor = 100.00, ui_type = "slider", min = -300.00, max = 300.00, step = 1.00 },
                strength = { value = 0.00, ui_type = "slider", min = 0.00, max = 200.00, step = 1.00 },
