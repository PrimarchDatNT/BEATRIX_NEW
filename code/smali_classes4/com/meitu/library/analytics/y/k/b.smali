.class public Lcom/meitu/library/analytics/y/k/b;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/meitu/library/analytics/y/k/b$c;,
        Lcom/meitu/library/analytics/y/k/b$b;
    }
.end annotation
...
.method public static a(Lcom/meitu/library/analytics/sdk/content/f;)Lcom/meitu/library/analytics/y/k/a;
    .locals 2
    ...
    new-instance v0, Lcom/meitu/library/analytics/y/k/c;

    invoke-static {}, Lcom/meitu/library/analytics/y/k/b;->c()Lokhttp3/OkHttpClient;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/meitu/library/analytics/y/k/c;-><init>(Lokhttp3/OkHttpClient;)V
...
.method public static b(Ljava/lang/String;)Lcom/meitu/library/analytics/y/k/a;
    .locals 2
...
.method public static c()Lokhttp3/OkHttpClient;
    ...
    sget-object v1, Lcom/meitu/library/analytics/y/k/b;->a:Lokhttp3/OkHttpClient;
    ...
    :cond_0
    const-class v1, Lcom/meitu/library/analytics/y/k/b;

    monitor-enter v1

    :try_start_0
    sget-object v2, Lcom/meitu/library/analytics/y/k/b;->a:Lokhttp3/OkHttpClient;
    ...
    invoke-virtual {v3}, Lcom/meitu/library/analytics/sdk/content/f;->X()Z

    move-result v4

    if-nez v4, :cond_2

    invoke-virtual {v3}, Lcom/meitu/library/analytics/sdk/content/f;->i0()Z
    ...
    :cond_2
    new-instance v3, Lcom/meitu/library/analytics/y/k/b$b;

    const/4 v4, 0x0

    invoke-direct {v3, v4}, Lcom/meitu/library/analytics/y/k/b$b;-><init>(Lcom/meitu/library/analytics/y/k/b$a;)V

    invoke-static {v3}, Lcom/meitu/library/analytics/y/k/b;->d(Ljavax/net/ssl/TrustManager;)Ljavax/net/ssl/SSLContext;
    ...
    new-instance v5, Lcom/meitu/library/analytics/y/k/b$c;

    invoke-direct {v5, v4}, Lcom/meitu/library/analytics/y/k/b$c;-><init>(Lcom/meitu/library/analytics/y/k/b$a;)V
    ...
    sput-object v2, Lcom/meitu/library/analytics/y/k/b;->a:Lokhttp3/OkHttpClient;
